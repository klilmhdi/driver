...
import 'package:driver/pages/NavigatorPages/editprofile.dart';
import 'package:driver/pages/NavigatorPages/history.dart';
import 'package:driver/pages/NavigatorPages/makecomplaint.dart';
import 'package:driver/pages/login/get_started.dart';
import 'package:driver/pages/login/login.dart';
import 'package:driver/pages/login/otp_page.dart';
import 'package:driver/pages/onTripPage/droplocation.dart';
import 'package:driver/pages/onTripPage/invoice.dart';
import 'package:driver/pages/onTripPage/map_page.dart';
import 'package:driver/pages/onTripPage/review_page.dart';
import 'package:driver/pages/vehicleInformations/referral_code.dart';
import 'package:driver/pages/vehicleInformations/service_area.dart';
import 'package:driver/pages/vehicleInformations/upload_docs.dart';
import 'package:driver/pages/vehicleInformations/vehicle_color.dart';
import 'package:driver/pages/vehicleInformations/vehicle_make.dart';
import 'package:driver/pages/vehicleInformations/vehicle_model.dart';
import 'package:driver/pages/vehicleInformations/vehicle_number.dart';
import 'package:driver/pages/vehicleInformations/vehicle_type.dart';
import 'package:http/http.dart' as http;
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:driver/pages/vehicleInformations/vehicle_year.dart';
import 'package:driver/styles/styles.dart';
...
String mapkey = 'AIzaSyBS5O_Ep-LSr-QGulq9iJ619jJn4qzXc3Y';
String mapStyle = '';
